...
interface WebGLManagerHandle {
  output?: { simulation?: SimulationHandle };
  autoDriver?: AutoDriverHandle;
  start(): void;
  pause(): void;
  resize(): void;
  dispose(): void;
...
const LiquidEther = ({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      _onMouseMove: (event: MouseEvent) => void = this.onDocumentMouseMove.bind(this);
      _onTouchStart: (event: TouchEvent) => void = this.onDocumentTouchStart.bind(this);
      _onTouchMove: (event: TouchEvent) => void = this.onDocumentTouchMove.bind(this);
      _onTouchEnd: () => void = this.onTouchEnd.bind(this);
      _onDocumentLeave: () => void = this.onDocumentLeave.bind(this);
    ...
    class AutoDriver {
      ...
      constructor(mouse: MouseClass, manager: { lastUserInteraction: number }, opts: AutoDriverOpts) {
        this.mouse = mouse;
...
`;
    ...
    class ExternalForce extends ShaderPass {
      ...
      setup(simProps: ExternalForceSimProps) {
        super.init();
